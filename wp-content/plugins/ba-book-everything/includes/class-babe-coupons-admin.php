...
/////////////////////
    ...
    $defaults['amount'] = __('Amount', BABE_TEXTDOMAIN);
    $defaults['status'] = __('Status', BABE_TEXTDOMAIN);
    $defaults['expiration_date'] = __('Expiration date', BABE_TEXTDOMAIN);
...
///////////////////////////////////
    ...
    if ($column_name === 'amount') {
	    $coupon_amount = BABE_Coupons::get_coupon_amount($post_id, true);
...
//////////////////////////////
    ...
    public static function add_coupons_settings($option_menu_slug, $option_name) {
        ...
        add_settings_section(
            ...
            __('Coupons', BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            'coupons_active', // ID
            __('Activate Coupons', BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Coupon expires in (days)', BABE_TEXTDOMAIN), // Title
