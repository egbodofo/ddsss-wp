...
//////////////////////////////
    ...
    public static function init() {
        ...
        add_action( 'delete_comment', array( __CLASS__, 'action_delete_comment'), 10, 2 );
...
/////////////////////////////////////
    ...
    */
    public static function action_delete_comment( $comment_id, $comment ){
...
////////////////////////
	 ...
	 */
     public static function comment_stars_rendering($comment_id = 0){
        ...
        $criteria_num = $comment_id ? sizeof($comment_rating_arr) : sizeof($rating_criteria);
        ...
        foreach ($rating_criteria as $rating_name => $rating_title){
           if (!$comment_id || ($comment_id && isset($comment_rating_arr[$rating_name]))){ 
            ...
            $rating = isset($comment_rating_arr[$rating_name]) ? floatval($comment_rating_arr[$rating_name]) : 0;
...
////////////////////////
	 ...
	 */
     public static function post_stars_rendering($post_id){
        ...
        $by_reviews_text = $total_votes > 1 ? sprintf(__( 'by %d reviews', BABE_TEXTDOMAIN ), $total_votes) : '';
     ...
     public static function new_comment_added($comment_id, $comment_approved, $commentdata){
        ...
        if (isset($_POST['rating'])){
            ...
            if ($comment_approved == 1){ ///the comment is approved
                //// add post rating
                self::update_post_rating($commentdata['comment_post_ID'], $sanitized_post_arr);
            }
        }
...
////////////////////////
	 ...
	 */
     public static function comment_form_field_comment($field){
        ...
        $field = '<p class="comment-form-rating"><label>'.__('Rating:', BABE_TEXTDOMAIN).'</label>
	 ...
	 */
     public static function get_post_rating($post_id){
        ...
        foreach ($rating_criteria as $rating_name => $rating_title){
                ...
                $current_rating_score = absint(get_post_meta($post_id, '_rating_score_'.$rating_name, 1));
                $current_rating_votes = absint(get_post_meta($post_id, '_rating_votes_'.$rating_name, 1));
...
////////////////////////
	 ...
	 */
     public static function get_post_total_rating($post_id){
        ...
        return floatval(get_post_meta( $post_id, '_rating', 1 ));
...
////////////////////////
	 ...
	 */
     public static function get_comment_total_rating($comment_id){
        ...
        return floatval(get_comment_meta( $comment_id, '_rating', 1 ));
...
////////////////////////
	 ...
	 */
     public static function calculate_rating($rating_arr){
        ...
        $num = sizeof($rating_arr);
        
        $num = $num ? $num : 1;
        
        $output = round(array_sum($rating_arr)/$num, 2);
        
        $output = apply_filters('babe_rating_calculate_total', $output, $rating_arr);
...
/////////////////////
    ...
    $defaults['rating']   = __('Rating', BABE_TEXTDOMAIN);
