...
///////////////////////////////////////    
    public static function init() {
        ...
        add_action( 'admin_init', array( __CLASS__, 'babe_admin_footer' ), 20 );
    ...
    public static function enqueued_assets() {
     ...
     if ( isset($_GET['page']) && ($_GET['page'] == BABE_Settings::$option_menu_slug || $_GET['page'] == 'babe-addons' || $_GET['page'] == 'babe-demo-content' ) ){   
        ...
        if(function_exists( 'wp_enqueue_media' )){
         ...
         wp_enqueue_style( 'babe-admin-settings', plugins_url( "css/admin/babe-admin-settings.css", BABE_PLUGIN ));
      }
     }
...
///////////////////////////////////////
	 ...
	 * Change admin footer.
	 */
    public static function babe_admin_footer() {
...
///////////////////////////////////////    
    ...
    public static function add_settings_page(){
        ...
        add_menu_page(
            __('BA Book Everything Settings', BABE_TEXTDOMAIN),
            __('BA Settings', BABE_TEXTDOMAIN),
            'manage_options',
        ...
        add_submenu_page( 
          BABE_Settings::$option_menu_slug,
          __('Addons and Themes', BABE_TEXTDOMAIN),
          __('Addons and Themes', BABE_TEXTDOMAIN),
          'manage_options',
          'babe-addons',
        ...
        add_submenu_page( 
          BABE_Settings::$option_menu_slug,
          __('Demo content', BABE_TEXTDOMAIN),
          __('Demo content', BABE_TEXTDOMAIN),
          'manage_options',
          'babe-demo-content',
...
///////////////////////////////////////    
    ...
    public static function create_demo_content_page()
    {
        ...
        <div class="wrap babe-demo-content-wrap">
            <h2><?php echo __('Demo content setup page', BABE_TEXTDOMAIN); ?></h2>
            
            <div class="babe-addons-browser wp-clearfix"><?php echo __('This tool will allow you to setup demo content to make it easy to get started with the BA Book Everything plugin. Demo content includes: booking rules, ages, features taxonomy, categories, service posts, places posts, FAQ posts and booking object posts. Please do not close this page during the installation of demo content.', BABE_TEXTDOMAIN); ?>            
            </div>
            <p>
              <button id="babe_demo_setup_button" class="button button-primary button-hero"><?php echo __('Setup Demo Content', BABE_TEXTDOMAIN); ?></button>
            </p>
            <p>
...
///////////////////////////////////////    
    ...
    public static function ajax_setup_demo_content(){
        ...
        if (isset($_POST['nonce']) && wp_verify_nonce( $_POST['nonce'], 'setup-demo' ) && isset($_POST['i'])){  
            ...
            echo __('Setup ages and taxonomies...', BABE_TEXTDOMAIN);
            ...
            echo __('Setup images...', BABE_TEXTDOMAIN);
            
            elseif ($i == 3):
            
            BABE_Install::setup_images();
            
            echo __('Setup places, service and FAQ posts ...', BABE_TEXTDOMAIN);
            ...
            echo __('Setup rules, categories, booking object posts...', BABE_TEXTDOMAIN);
            ...
            echo __('Done!', BABE_TEXTDOMAIN);
            
            echo '<div class="setup_result">
             <div class="setup_result_title">'.__('Next steps:', BABE_TEXTDOMAIN).'</div>
             <ul>
              <li>'.sprintf(__('Go to %1$sAll items%2$s page and check created items on front-end', BABE_TEXTDOMAIN), '<a href="' . esc_url( get_permalink($page_all_items_id) ) . '" target="_blank">', '</a>').'</li>
              <li>'.sprintf(__('Edit demo content or create your own (read setting details in %1$sDocumentation%2$s)', BABE_TEXTDOMAIN), '<a href="https://ba-booking.com/ba-book-everything/documentation/setup-environment/" target="_blank">', '</a>').'</li>
             </ul>
            </div>';
...
///////////////////////////////////////    
    ...
    public static function create_addons_page()
    {
        ?>
        <div class="wrap">
            <h2><?php echo __('Addons and Themes for BA Book Everything plugin', BABE_TEXTDOMAIN); ?></h2>
          ...
          <div class="babe-addon">
            ...
            <div class="babe-addon-container">
              <a href="https://ba-booking.com/shop/downloads/ba-book-everything-payment-pack/">
			   <h2 class="babe-addon-name"><?php echo __('BABE Payment pack', BABE_TEXTDOMAIN); ?></h2>
              </a> 
               <div class="babe-addon-description">
				   <?php echo __('Integrates PayPal and Credit Cards (Stripe) payments. Stripe integration supports 3D Secure card payments, Apple Pay, Google Pay, Microsoft Pay and the Payment Request API.', BABE_TEXTDOMAIN); ?>
               </div>
            
               <div class="babe-addon-actions">
				   <a class="button button-primary" href="https://ba-booking.com/shop/downloads/ba-book-everything-payment-pack/"><?php echo __('Learn more', BABE_TEXTDOMAIN); ?></a>
               </div>
            </div>
            ...
            <div class="babe-addon-container">
              <a href="https://ba-booking.com/shop/downloads/babe-backoffice/">
			   <h2 class="babe-addon-name"><?php echo __('BABE Backoffice', BABE_TEXTDOMAIN); ?></h2>
              </a> 
               <div class="babe-addon-description">
				   <?php echo __('Management tools: PDF invoices, backend bookings, editing/cancelation orders, extra charge, full and partial refund, iCal synchronization.', BABE_TEXTDOMAIN); ?>
               </div>
            
               <div class="babe-addon-actions">
				   <a class="button button-primary" href="https://ba-booking.com/shop/downloads/babe-backoffice/"><?php echo __('Learn more', BABE_TEXTDOMAIN); ?></a>
               </div>
            </div>
          ...
          <div class="babe-addon">
            ...
            <div class="babe-addon-container">
              <a href="https://ba-booking.com/ba-tours/">
			   <h2 class="babe-addon-name"><?php echo __('BA Tours theme', BABE_TEXTDOMAIN); ?></h2>
              </a> 
               <div class="babe-addon-description">
				   <?php echo __('BA Tours booking theme developed for travel agencies and tour operators of any size. It\'s bundled with BABE Payment pack - <b>you can save up to $49</b>!', BABE_TEXTDOMAIN); ?>
               </div>
            
               <div class="babe-addon-actions">
				   <a class="button button-primary" href="https://ba-booking.com/ba-tours-demo/"><?php echo __('View Demo', BABE_TEXTDOMAIN); ?></a>
                   <a class="button button-primary" href="https://ba-booking.com/ba-tours/"><?php echo __('Learn more', BABE_TEXTDOMAIN); ?></a>                   
               </div>
            </div>
          ...
          <div class="babe-addon">
            ...
            <div class="babe-addon-container">
              <a href="https://ba-booking.com/ba-hotel/">
			   <h2 class="babe-addon-name"><?php echo __('BA Hotel theme', BABE_TEXTDOMAIN); ?></h2>
              </a> 
               <div class="babe-addon-description">
				   <?php echo __('Hotel booking theme developed for mini hotels and hostels. It\'s created with SEO in mind and gives you a high pagespeed score even without caching plugins. BABE Payment pack is included - <b>you can save up to $49</b>!', BABE_TEXTDOMAIN); ?>
               </div>
            
               <div class="babe-addon-actions">
				   <a class="button button-primary" href="https://ba-booking.com/ba-hotel-demo/"><?php echo __('View Demo', BABE_TEXTDOMAIN); ?></a>
                   <a class="button button-primary" href="https://ba-booking.com/ba-hotel/"><?php echo __('Learn more', BABE_TEXTDOMAIN); ?></a>                   
               </div>
            </div>
...
///////////////////////////////////////    
    ...
    public static function create_settings_page()
    {
        ...
        <div class="wrap babe-settings-wrap">
            <h2><?php echo __('BA Book Everything Settings', BABE_TEXTDOMAIN); ?></h2>
...
////////////////////////////////////////////////
    ...
    public static function settings_page_init()
    {
        ...
        add_settings_section(
            ...
            __('General',BABE_TEXTDOMAIN), // Title
         ...
         add_settings_field(
            'date_format', // ID
            __('Date format',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Use Gutenberg for booking object posts',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Booking object post slug',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Booking object singular name',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Booking object general (plural) name',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Booking object menu name',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Select search result page',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            'services_page', // ID
            __('Services page',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_page_select' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            'checkout_page', // ID
            __('Checkout page',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_page_select' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Confirmation page',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_page_select' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            'my_account_page', // ID
            __('My Account page',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_page_select' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            'terms_page', // ID
            __('Terms & Conditions page',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_page_select' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Admin page for order confirmation (for manually availability confirmation)',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_page_select' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Booking form: maximum number of guests available to choose',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            'results_per_page', // ID
            __('Search result: items per page',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Taxonomy archive page: items per page',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            ...
            __('Maximum number of months in availability calendar',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            'results_view', // ID
            __('Search result view',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            'content_in_tabs', // ID
            __('Show booking object post content in tabs?',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'is_active_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general', // Section
        ...
        add_settings_field(
            'reviews_in_tabs', // ID
            __('Show reviews in tab on booking object page?',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'is_active_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general', // Section
        ...
        add_settings_field(
            ...
            __('Reviews comment template (leave empty to use the default "/comments.php")',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general',  // Section
        ...
        add_settings_field(
            'mpoints_active', // ID
            __('Add meeting points functionality?',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_mpoints_active' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general' // Section
        );
        ...
        add_settings_field(
            ...
            __('Media library filter: show only current user attachments and unattached madia in the Media library', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_view_only_uploaded_images' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general' // Section
        );
        ...
        add_settings_field(
            ...
            __('Remove unitegallery from booking object pages', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_unitegallery_remove' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general' // Section
        );
        ...
        add_settings_field(
            ...
            __('Remove availability calendar from booking object pages', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_av_calendar_remove' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general' // Section
        );
        ...
        add_settings_field(
            ...
            __('Remove google map from booking object pages', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_google_map_remove' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general' // Section
        );
        ...
        add_settings_field(
            ...
            __('Add services to booking form', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_services_to_booking_form' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_general' // Section
        );
        ...
        add_settings_section(
            ...
            __('Currency',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            'currency', // ID
            __('Select base currency',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            'currency_place', // ID
            __('Place of currency symbol in displayed prices',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Thousand Separator of displayed prices',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_currency',  // Section
        ...
        add_settings_field(
            ...
            __('Decimal Separator of displayed prices',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_currency',  // Section
        ...
        add_settings_field(
            'price_decimals', // ID
            __('Number of decimal points shown in displayed prices',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_currency',  // Section
        ...
        add_settings_section(
            ...
            __('Payments',BABE_TEXTDOMAIN), // Title
            '__return_false', // Callback
            BABE_Settings::$option_menu_slug // Page
        );
        ...
        add_settings_field(
            'payment_methods', // ID
            __('Activate payment methods',BABE_TEXTDOMAIN), // Title
        ...
        if (empty(BABE_Payments::$payment_methods)){
            BABE_Payments::$payment_methods['cash'] = __('Pay later',BABE_TEXTDOMAIN);
        }
        ...
        foreach(BABE_Payments::$payment_methods as $method => $method_title){
          ...
          if ($method != 'cash'){  
            ...
            add_settings_field(
              ...
              __('Gateway: ',BABE_TEXTDOMAIN).$method_title, // Title
              '__return_false', // Callback
              BABE_Settings::$option_menu_slug, // Page
              'setting_section_payment' // Section
            );
        ...
        add_settings_section(
            ...
            __('Order',BABE_TEXTDOMAIN), // Title
            '__return_false', // Callback
            BABE_Settings::$option_menu_slug // Page
        );
        ...
        add_settings_field(
            ...
            __('Confirm item availability',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Waiting before delete orders with "payment processing" status, minutes',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_order',  // Section
        ...
        add_settings_section(
            ...
            __('Confirmation', BABE_TEXTDOMAIN), // Title
            '__return_false', // Callback
            BABE_Settings::$option_menu_slug // Page
        );
        ...
        add_settings_field(
            ...
            __('Message for status "availability confirmation"', BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Message for status "not available"', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_confirm',  // Section
        ...
        add_settings_field(
            ...
            __('Message for status "payment deferred"', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_confirm',  // Section
        ...
        add_settings_field(
            ...
            __('Message for status "payment expected"', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_confirm',  // Section
        ...
        add_settings_field(
            ...
            __('Message for status "payment processing"', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_confirm',  // Section
        ...
        add_settings_field(
            ...
            __('Message for status "payment received"', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_confirm',  // Section
        ...
        add_settings_section(
            ...
            __('Emails',BABE_TEXTDOMAIN), // Title
            '__return_false', // Callback
            BABE_Settings::$option_menu_slug // Page
        );
        ...
        add_settings_field(
            ...
            __('Emails template settings', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
        ...
        add_settings_field(
            'email_logo', // ID
            __('Logo image',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Header image',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'img_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            ...
            __('Footer text (contacts, etc.)',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            ...
            __('Credits text (copyright, etc.)',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            ...
            __('Customer New order email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Subject', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',  // Section
        ...
        add_settings_field(
            ...
            __('Body title', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',  // Section
        ...
        add_settings_field(
            ...
            __('Body message', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'textarea_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',  // Section
        ...
        add_settings_field(
            ...
            __('Customer availability confirmation email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Customer order to pay email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Customer order rejected email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Customer canceled the order email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Customer account created email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Customer password reseted email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Admin New order email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Admin availability confirmation email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Admin order canceled email', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            ...
            __('Emails color scheme', BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'title_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails',
            array('class' => 'babe_settings_subtitle')
        ...
        add_settings_field(
            'email_color_font', // ID
            __('Font color',BABE_TEXTDOMAIN), // Title
        ...
        add_settings_field(
            ...
            __('Background color',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'color_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            ...
            __('Titles color',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'color_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            'email_color_link', // ID
            __('Links color',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'color_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            ...
            __('Button default color',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'color_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            ...
            __('Confirm button color',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'color_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_field(
            ...
            __('Cancel button color',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'color_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_emails', // Section
        ...
        add_settings_section(
            ...
            __('Google map',BABE_TEXTDOMAIN), // Title
            '__return_false', // Callback
            BABE_Settings::$option_menu_slug // Page
        );
        ...
        add_settings_field(
            ...
            __('Add google map functionality?',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'setting_google_map_active' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
        ...
        add_settings_field(
            'google_api', // ID
            __('Google API key (see ',BABE_TEXTDOMAIN).'<a href="https://developers.google.com/maps/documentation/embed/get-api-key" target="blank">Google Maps API docs</a>'.__(' for details).',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_google',  // Section
        ...
        add_settings_field(
            'google_map_zoom', // ID
            __('Map zoom',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_google',  // Section
        ...
        add_settings_field(
            ...
            __('Map start latitude',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_google',  // Section
        ...
        add_settings_field(
            ...
            __('Map start Longitude',BABE_TEXTDOMAIN), // Title
            array( __CLASS__, 'text_field_callback' ), // Callback
            BABE_Settings::$option_menu_slug, // Page
            'setting_section_google',  // Section
        ...
        add_settings_field(
            ...
            __('Select map marker',BABE_TEXTDOMAIN), // Title
...
/////////////////////////////////////
    ...
    public static function img_field_callback($args){
       $img_src = isset( BABE_Settings::$settings[$args['option']] ) ? BABE_Settings::$settings[$args['option']] : '';
        ...
        echo '<input type="text" id="'.$args['option'].'" name="'.$args['settings_name'].'['.$args['option'].']" value="'.$img_src.'" /><input type="button" class="'.$args['option'].'_upload" value="'.__('Upload', BABE_TEXTDOMAIN).'"></div>';
    ...
    jQuery(document).ready(function($) {
        $(\'.'.$args['option'].'_upload\').click(function(e) {
            ...
            var custom_uploader = wp.media({
                title: \''.__('Custom Image', BABE_TEXTDOMAIN).'\',
                button: {
                    text: \''.__('Upload Image', BABE_TEXTDOMAIN).'\'
                },
...
/////////////////////////////////////////
    ...
    public static function setting_currency_place(){
		...
		$options  = array(
			'left'        => __( 'Left', BABE_TEXTDOMAIN ) . ' (' . BABE_Currency::get_currency_symbol() . '99.99)',
			'right'       => __( 'Right', BABE_TEXTDOMAIN ) . ' (99.99' . BABE_Currency::get_currency_symbol() . ')',
			'left_space'  => __( 'Left with space', BABE_TEXTDOMAIN ) . ' (' . BABE_Currency::get_currency_symbol() . ' 99.99)',
			'right_space' => __( 'Right with space', BABE_TEXTDOMAIN ) . ' (99.99 ' . BABE_Currency::get_currency_symbol() . ')'
		);
...
//////////////////////////////////////    
    ...
    public static function setting_google_map_active(){

        $check = isset(BABE_Settings::$settings['google_map_active']) ?  BABE_Settings::$settings['google_map_active'] : 0;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_active]1" name="'.BABE_Settings::$option_name.'[google_map_active]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_google_map_active1" for="'.BABE_Settings::$option_name.'[google_map_active]1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_active]2" name="'.BABE_Settings::$option_name.'[google_map_active]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_google_map_active2" for="'.BABE_Settings::$option_name.'[google_map_active]2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';
...
///////////////////////////////////////////////
    ...
    public static function is_active_callback($args){
        ...
        $check = isset(BABE_Settings::$settings[$args['option']]) ?  BABE_Settings::$settings[$args['option']] : $default;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.$args['settings_name'].'['.$args['option'].']1" name="'.$args['settings_name'].'['.$args['option'].']" type="radio" value="1" '.$checked1.'/><label for="'.$args['settings_name'].'['.$args['option'].']1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.$args['settings_name'].'['.$args['option'].']2" name="'.$args['settings_name'].'['.$args['option'].']" type="radio" value="0" '.$checked2.'/><label for="'.$args['settings_name'].'['.$args['option'].']2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';
       
    }

////////////mpoints_active///////////////////

    public static function setting_mpoints_active(){

        $check = isset(BABE_Settings::$settings['mpoints_active']) ?  BABE_Settings::$settings['mpoints_active'] : 0;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.BABE_Settings::$option_name.'[mpoints_active]1" name="'.BABE_Settings::$option_name.'[mpoints_active]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_mpoints_active1" for="'.BABE_Settings::$option_name.'[mpoints_active]1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[mpoints_active]2" name="'.BABE_Settings::$option_name.'[mpoints_active]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_mpoints_active2" for="'.BABE_Settings::$option_name.'[mpoints_active]2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';

}

/////////////setting_view_only_uploaded_images

    public static function setting_view_only_uploaded_images(){

        $check = isset(BABE_Settings::$settings['view_only_uploaded_images']) ?  BABE_Settings::$settings['view_only_uploaded_images'] : 0;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.BABE_Settings::$option_name.'[view_only_uploaded_images]1" name="'.BABE_Settings::$option_name.'[view_only_uploaded_images]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_view_only_uploaded_images1" for="'.BABE_Settings::$option_name.'[view_only_uploaded_images]1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[view_only_uploaded_images]2" name="'.BABE_Settings::$option_name.'[view_only_uploaded_images]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_view_only_uploaded_images2" for="'.BABE_Settings::$option_name.'[view_only_uploaded_images]2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';

}

/////////////setting_unitegallery_remove///////////////////////

     public static function setting_unitegallery_remove(){

        $check = isset(BABE_Settings::$settings['unitegallery_remove']) ?  BABE_Settings::$settings['unitegallery_remove'] : 0;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.BABE_Settings::$option_name.'[unitegallery_remove]1" name="'.BABE_Settings::$option_name.'[unitegallery_remove]" type="radio" value="1" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_unitegallery_remove1" for="'.BABE_Settings::$option_name.'[unitegallery_remove]1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[unitegallery_remove]2" name="'.BABE_Settings::$option_name.'[unitegallery_remove]" type="radio" value="0" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_unitegallery_remove2" for="'.BABE_Settings::$option_name.'[unitegallery_remove]2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';

   }
   
////////////av_calendar_remove//////////////////   
     
    public static function setting_av_calendar_remove(){

        $check = isset(BABE_Settings::$settings['av_calendar_remove']) ?  BABE_Settings::$settings['av_calendar_remove'] : 0;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.BABE_Settings::$option_name.'[av_calendar_remove]1" name="'.BABE_Settings::$option_name.'[av_calendar_remove]" type="radio" value="1" '.$checked1.'/><label for="'.BABE_Settings::$option_name.'[av_calendar_remove]1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[av_calendar_remove]2" name="'.BABE_Settings::$option_name.'[av_calendar_remove]" type="radio" value="0" '.$checked2.'/><label for="'.BABE_Settings::$option_name.'[av_calendar_remove]2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';

   }
   
/////////////setting_google_map_remove///////////////////////

     public static function setting_google_map_remove(){

        $check = isset(BABE_Settings::$settings['google_map_remove']) ?  BABE_Settings::$settings['google_map_remove'] : 0;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_remove]1" name="'.BABE_Settings::$option_name.'[google_map_remove]" type="radio" value="1" '.$checked1.'/><label for="'.BABE_Settings::$option_name.'[google_map_remove]1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[google_map_remove]2" name="'.BABE_Settings::$option_name.'[google_map_remove]" type="radio" value="0" '.$checked2.'/><label for="'.BABE_Settings::$option_name.'[google_map_remove]2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';
...
/////////////results_view///////////////////////
     ...
     public static function setting_results_view(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[results_view]1" name="'.BABE_Settings::$option_name.'[results_view]" type="radio" value="full" '. checked( 'full', $check, 0 ) .'/><label for="'.BABE_Settings::$option_name.'[results_view]1">'.__('Full', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[results_view]2" name="'.BABE_Settings::$option_name.'[results_view]" type="radio" value="grid" '. checked( 'grid', $check, 0 ) .'/><label for="'.BABE_Settings::$option_name.'[results_view]2">'.__('Grid', BABE_TEXTDOMAIN).'</label></p>';

   }      
   
/////////////services_to_booking_form///////////////////////

     public static function setting_services_to_booking_form(){

        $check = isset(BABE_Settings::$settings['services_to_booking_form']) ?  BABE_Settings::$settings['services_to_booking_form'] : 0;

        $checked1 = $check ? 'checked' : '';
        $checked2 = !$check ? 'checked' : '';

        echo '<p><input id="'.BABE_Settings::$option_name.'[services_to_booking_form]1" name="'.BABE_Settings::$option_name.'[services_to_booking_form]" type="radio" value="1" '.$checked1.'/><label for="'.BABE_Settings::$option_name.'[services_to_booking_form]1">'.__('Yes', BABE_TEXTDOMAIN).'</label></p>';
       echo '<p><input id="'.BABE_Settings::$option_name.'[services_to_booking_form]2" name="'.BABE_Settings::$option_name.'[services_to_booking_form]" type="radio" value="0" '.$checked2.'/><label for="'.BABE_Settings::$option_name.'[services_to_booking_form]2">'.__('No', BABE_TEXTDOMAIN).'</label></p>';
...
////////setting_order_availability_confirm
    ...
    public static function setting_order_availability_confirm(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[order_availability_confirm]1" name="'.BABE_Settings::$option_name.'[order_availability_confirm]" type="radio" value="auto" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_order_availability_confirm1" for="'.BABE_Settings::$option_name.'[order_availability_confirm]1">'.__('Automatically', BABE_TEXTDOMAIN).'</label></p>';
        echo '<p><input id="'.BABE_Settings::$option_name.'[order_availability_confirm]2" name="'.BABE_Settings::$option_name.'[order_availability_confirm]" type="radio" value="manually" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_order_availability_confirm2" for="'.BABE_Settings::$option_name.'[order_availability_confirm]2">'.__('Manually (by dashboard or e-mail)', BABE_TEXTDOMAIN).'</label></p>';       
...
/////////////////////
    ...
    public static function setting_date_format(){
        ...
        echo '<p><input id="'.BABE_Settings::$option_name.'[date_format]1" name="'.BABE_Settings::$option_name.'[date_format]" type="radio" value="d/m/Y" '.$checked1.'/><label id="'.BABE_Settings::$option_name.'_date_format1" for="'.BABE_Settings::$option_name.'[date_format]1">'.__('d/m/Y', BABE_TEXTDOMAIN).'</label></p>';
        echo '<p><input id="'.BABE_Settings::$option_name.'[date_format]2" name="'.BABE_Settings::$option_name.'[date_format]" type="radio" value="m/d/Y" '.$checked2.'/><label id="'.BABE_Settings::$option_name.'_date_format2" for="'.BABE_Settings::$option_name.'[date_format]2">'.__('m/d/Y', BABE_TEXTDOMAIN).'</label></p>';       
