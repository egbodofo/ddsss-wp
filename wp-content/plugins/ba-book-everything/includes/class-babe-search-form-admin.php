...
///////////////////////////////////////
    ...
    public static function enqueue_scripts() {
     ...
     wp_enqueue_script( 'babe-admin-searchform-js', plugins_url( "js/admin/babe-admin-searchform.js", BABE_PLUGIN ), array('jquery'), '1.0', true );
     ...
     wp_enqueue_style( 'babe-admin-searchform-style', plugins_url( "css/admin/babe-admin-searchform.css", BABE_PLUGIN ));
...
///////////////////////////////////////    
    ...
    public static function add_admin_menu_page(){
        ...
        add_submenu_page( 'edit.php?post_type='.BABE_Post_types::$booking_obj_post_type, __('Search Form', BABE_TEXTDOMAIN), __('Search Form', BABE_TEXTDOMAIN), 'manage_options', 'search_form', array( __CLASS__, 'create_admin_page' ));
...
///////////////////////////////////////
    ...
    public static function create_admin_page(){
        ...
        ?>
        <div class="wrap">
            <h2><?php echo __('Search Form builder', BABE_TEXTDOMAIN); ?></h2>
            
            <hr />
            
            <h3><?php echo __('Search form Tabs', BABE_TEXTDOMAIN); ?></h3>
            ...
            <div id="search-form-tabs-new">
               <label for="search_form_tab_title"><?php echo __('Tab Title:', BABE_TEXTDOMAIN); ?></label> <input type="text" id="search_form_tab_title" name="search_form_tab_title" value=""/>
               <label for="search_form_tab_slug"><?php echo __('Tab slug:', BABE_TEXTDOMAIN); ?></label> <input type="text" id="search_form_tab_slug" name="search_form_tab_slug" value=""/>
                <i><?php echo __('Only a-z letters allowed.', BABE_TEXTDOMAIN); ?></i>
                <br />
               <?php 
               ...
               if ( !empty($categories) ){
                 ?>
                <label><?php echo __('Apply to categories (check nothing for all):', BABE_TEXTDOMAIN); ?></label><ul id="search_form_tab_categoties">
                 <?php
               ...
               ?>
               <span id="add_search_tab" class="button-primary btn"><?php echo __('Add new Tab', BABE_TEXTDOMAIN); ?></span> <span class="spinner" id="search_form_tabs_spinner"></span><span id="search_form_tabs_spinner_done" class="task_done"><?php echo __('Done!', BABE_TEXTDOMAIN); ?></span>
            </div>
            <br />
            <hr />
            <h3><?php echo __('General settings', BABE_TEXTDOMAIN); ?></h3>
            <?php
            ...
            echo '<label for="show_price_slider">'.__('Show price range picker in Advanced field', BABE_TEXTDOMAIN).'</label>';
            ?>
            <br />
            <br />
            <hr />

            <h3><?php echo __('Managing search form fields', BABE_TEXTDOMAIN); ?></h3>
            ...
            <div id="search-form-fields-update">
              <span id="update_search_fields" class="button-primary btn"><?php echo __('Save changes in fields', BABE_TEXTDOMAIN); ?></span> <span class="spinner" id="search_form_fields_spinner"></span><span id="search_form_fields_spinner_done" class="task_done"><?php echo __('Done!', BABE_TEXTDOMAIN); ?></span>
            </div>
            ...
            <div id="confirm_del_tab" class="babe_overlay_inner">
              ...
              <h1>'.__('Delete selected tab?', BABE_TEXTDOMAIN).'</h1>
...
///////////////////////////////////////    
    ...
    public static function ajax_add_tab(){
        ...
        $output = [
            'tabs' => __('An error occurred while processing...', BABE_TEXTDOMAIN),
            'fields' => '',
        ];
        ...
        if ( isset($_POST['tab_title']) && isset($_POST['tab_slug']) && isset($_POST['nonce']) && wp_verify_nonce( $_POST['nonce'], self::$nonce_title )){
           ...
           if ( $tab_title && $tab_slug ){
              ...
              $output['tabs'] = __('Please, fill in the correct data', BABE_TEXTDOMAIN);
       ...
       if ( !empty(BABE_Search_From::$search_form_tabs) ){
          ...
          foreach ( BABE_Search_From::$search_form_tabs as $tab_slug => $tab_arr){
            ...
            if ( !empty($tab_arr['categories']) ){
                ...
                $tab_categories_list = implode(', ', $tab_categories_arr);
                
            } else {
                $tab_categories_list = __('All', BABE_TEXTDOMAIN);
            }
            ...
            <div class="search_form_tab_item" data-order="'.$i.'" data-tab-slug="'.$tab_slug.'">'.$tab_arr['title'].' ('.$tab_slug.')
                 ...
                 <div class="search_form_tab_item_cats">'.__('categories:', BABE_TEXTDOMAIN).' '.$tab_categories_list.'</div>
            </div>';
      ...
      foreach ( BABE_Search_From::$search_form_all_fields as $field_slug => $field_name){
          ...
          <tr class="search-form-fields-row" data-field-slug="'.$field_slug.'" data-order="'.$i.'">
             <td class="search-form-fields-row-title"><h3>'.$field_name.'</h3>
                 <label for="search_field_icon_'.$field_slug.'">'.__('Icon classes:', BABE_TEXTDOMAIN).'</label>
          ...
          if ( $field_slug !== 'date_from' && $field_slug !== 'date_to' && $field_slug !== 'guests'  ){
              $output .= '<br />
                    ...
                    <label for="search_field_advanced_tab_'.$field_slug.'">'.__('advanced field', BABE_TEXTDOMAIN).'</label>
                    ';
          }
          ...
          foreach ( $tabs as $tab_ind => $tab_arr ){
             ...
             <td class="search-form-fields-row-value">
                 <label for="search_field_title_'.$field_slug.'_'.$tab_ind.'">'.__('Title:', BABE_TEXTDOMAIN).'</label>
              ...
              if ( $field_slug !== 'date_from' ){
                  ...
                  $output .= '
                    ...
                    <label for="search_field_active_'.$field_slug.'_'.$tab_ind.'">'.__('active', BABE_TEXTDOMAIN).'</label><br />
                    ';
              ...
              if ($field_slug === 'date_from' || $field_slug === 'date_to' || $field_slug === 'guests'){
                  ...
                  $option_title = $field_slug == 'guests' ? __('with ages', BABE_TEXTDOMAIN) : __('add time', BABE_TEXTDOMAIN);
...
//////////////////////////////////////    
    ...
    public static function get_search_form_fields_thead(){
       ...
       <thead>
          ...
          <th>'.__('Feild name', BABE_TEXTDOMAIN).'</th>';
       ...
       if ( !empty(BABE_Search_From::$search_form_tabs) ){
          ...
          $output .= '<th>'.__('- without tabs -', BABE_TEXTDOMAIN).'</th>';
       }
