...
class BABE_Settings {
    ...
    /////unitegallery
    public static $unitegallery = array();
...
///////////////////////////////////////    
    public static function init() {
        ...
        self::$settings = wp_parse_args( get_option(self::$option_name), array(
            ...
            'booking_obj_post_name' => __( 'Booking Object', BABE_TEXTDOMAIN ),
            'booking_obj_post_name_general' => __( 'Booking Objects', BABE_TEXTDOMAIN ),
            'booking_obj_menu_name' => __( 'BA Book Everything', BABE_TEXTDOMAIN ),
            ...
            'message_av_confirmation' => __( "Your order is waiting for the availability confirmation, you will be notified by email when it's ready. Thank you!", BABE_TEXTDOMAIN ),
            'message_not_available' => __( 'Sorry, but your selected items are not available for selected dates/times. Please, search another dates/times or items and create new order.', BABE_TEXTDOMAIN ),
            'message_payment_deferred' => __( 'Your order is completed and received, and a confirmation email was sent to you. You will pay the full amount later. Thank you!', BABE_TEXTDOMAIN ),
            'message_payment_expected' => __( 'Your order is confirmed, but not completed. To complete your order, please, click the link below to make a payment.', BABE_TEXTDOMAIN ),
            'message_payment_processing' => __( 'Your order has been confirmed and your payment is being processed. Thank you!', BABE_TEXTDOMAIN ),
            'message_payment_received' => __( 'Your order is completed, your payment has been received, and a confirmation email was sent to you. Thank you!', BABE_TEXTDOMAIN ),
            'email_logo' => '',
            'email_header_image' => '',
            'email_footer_message' => '',
            'email_footer_credit' => '',
            'email_admin_new_order_subject' => __('New order #%s', BABE_TEXTDOMAIN),
            'email_admin_new_order_title' => __('New order', BABE_TEXTDOMAIN),
            'email_admin_new_order_message' => __('You have new order. Please, find details below.', BABE_TEXTDOMAIN),
            'email_admin_new_order_av_confirm_subject' => __('Availability request', BABE_TEXTDOMAIN),
            'email_admin_new_order_av_confirm_title' => __('New Order is waiting for confirmation', BABE_TEXTDOMAIN),
            'email_admin_new_order_av_confirm_message' => __('Please, confirm or reject this Order.', BABE_TEXTDOMAIN),
            'email_new_order_av_confirm_subject' => __('Your order #%s', BABE_TEXTDOMAIN),
            'email_new_order_av_confirm_title' => __('New Order created', BABE_TEXTDOMAIN),
            'email_new_order_av_confirm_message' => __('Hello, %s

Thank you for booking! Your Order is waiting for availability confirmation. We will send you a confirmation letter as soon as possible.', BABE_TEXTDOMAIN),
            'email_new_order_subject' => __('Your order #%s', BABE_TEXTDOMAIN),
            'email_new_order_title' => __('Your order has been received', BABE_TEXTDOMAIN),
            'email_new_order_message' => __('Hello, %1$s

Thank you for booking! Your order has been received.', BABE_TEXTDOMAIN),
            'email_new_order_to_pay_subject' => __('Your order is waiting for payment', BABE_TEXTDOMAIN),
            'email_new_order_to_pay_title' => __('Your order is waiting for payment', BABE_TEXTDOMAIN),
            'email_new_order_to_pay_message' => __('Hello, %1$s

Your order is confirmed, but not completed. To complete your order, click the link below to make a payment. Amount to pay is %2$s.', BABE_TEXTDOMAIN),
            'email_order_rejected_subject' => __('Selected items are not available', BABE_TEXTDOMAIN),
            'email_order_rejected_title' => __('Selected items are not available', BABE_TEXTDOMAIN),
            'email_order_rejected_message' => __('Hello, %s

Sorry, but your selected items are not available for selected dates/times. You could search another dates/times or items and create new Order.', BABE_TEXTDOMAIN),
            'email_new_customer_created_subject' => __('Your account details', BABE_TEXTDOMAIN),
            'email_new_customer_created_title' => __('Your account details', BABE_TEXTDOMAIN),
            'email_new_customer_created_message' => __('Hello, %s

Thank you for booking with us! You could use this login/password to manage your bookings:', BABE_TEXTDOMAIN),
            'email_password_reseted_subject' => __('Your password has been reset', BABE_TEXTDOMAIN),
            'email_password_reseted_title' => __('Your password has been reset.', BABE_TEXTDOMAIN),
            'email_password_reseted_message' => __('Hello, %s
            
Your password has been reset. You could use this new password to manage your account:', BABE_TEXTDOMAIN),
            'email_admin_order_canceled_subject' => __('Order # %1$s was canceled', BABE_TEXTDOMAIN),
            'email_admin_order_canceled_title' => __('Order has been canceled', BABE_TEXTDOMAIN),
            'email_admin_order_canceled_message' => __('The order has been canceled:', BABE_TEXTDOMAIN),
            'email_order_canceled_subject' => __('Your order was canceled', BABE_TEXTDOMAIN),
            'email_order_canceled_title' => __('Your order has been canceled', BABE_TEXTDOMAIN),
            'email_order_canceled_message' => __('Hello, %1$s

Your order has been canceled:', BABE_TEXTDOMAIN),
        ...
        self::$google_api_key = self::$settings['google_api'] ? self::$settings['google_api'] : 'AIzaSyCog6B_SyLr4S-8BNyxOaBTLb4A4V2im6Q';
...
///////////////////////////////////////
    ...
    public static function show_unattached_media_only($wp_query_obj) {
        ...
        if( $pagenow == 'upload.php' && $is_attachment_request && is_a( $current_user, 'WP_User')){
...
///////////////////////////////////////
    ...
    public static function init_rating_criteria() {
        ...
        if (empty($rating_criteria_arr)){
            $rating_criteria_arr['base'] = __('Single rating',BABE_TEXTDOMAIN);
        }
...
///////////////////////////////////////
    ...
    public static function get_checkout_page_url($args = array()) {
        ...
        return BABE_Functions::get_page_url_with_args(self::$settings['checkout_page'], $args);
    }
...
///////////////////////////////////////
    ...
    public static function get_services_page_url($args = array()) {
        ...
        return BABE_Functions::get_page_url_with_args(self::$settings['services_page'], $args);
    }    
...
///////////////////////////////////////
    ...
    public static function get_confirmation_page_url($args = array()) {
        ...
        return BABE_Functions::get_page_url_with_args(self::$settings['confirmation_page'], $args);
    }
...
///////////////////////////////////////
    ...
    public static function get_admin_confirmation_page_url($args = array()) {
        ...
        return BABE_Functions::get_page_url_with_args(self::$settings['admin_confirmation_page'], $args);
    }    
