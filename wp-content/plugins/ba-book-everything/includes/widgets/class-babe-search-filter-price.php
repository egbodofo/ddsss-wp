...
__('BA Price Filter', BABE_TEXTDOMAIN),
// Widget description
array( 'description' => __('Shows a price filter slider in a widget which lets you narrow down the list of shown items', BABE_TEXTDOMAIN), )
);
