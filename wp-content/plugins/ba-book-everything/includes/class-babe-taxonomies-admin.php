...
//////////////////////////////
    ...
    public static function taxonomies_list_column_header($columns) {
        $columns['tax_action'] = __( 'Action', BABE_TEXTDOMAIN );
        return $columns;
    }
//////////////////////////////
    /**
    ...
    public static function taxonomies_list_column_rows($content, $column_name, $term_id) {
        if ( 'tax_action' == $column_name ) {
            if (isset(BABE_Post_types::$taxonomies_list[$term_id]))
            $content = '<a href="'.admin_url( 'edit-tags.php?taxonomy='.BABE_Post_types::$taxonomies_list[$term_id]['slug'] ).'&post_type='.BABE_Post_types::$booking_obj_post_type.'">'.sprintf(__( 'Edit %s taxonomy', BABE_TEXTDOMAIN ), BABE_Post_types::$taxonomies_list[$term_id]['name']).'</a>';
        }
       return $content;
    }
//////////////////////////////    
