 ...
 * @access public
 */
final class hotel_center_lite_Example_1_Customize {
	...
	public function hotel_center_lite_sections( $manager ) {
		...
		$manager->register_section_type( 'hotel_center_lite_Example_1_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new hotel_center_lite_Example_1_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
...
hotel_center_lite_Example_1_Customize::hotel_center_lite_get_instance();