...
define('SUPERMARKET_ECOMMERCE_PRO_DOCS',__('https://www.luzukdemo.com/demo/supermarket-ecommerce/documentation','supermarket-ecommerce'));
...
function supermarket_ecommerce_sanitize_email( $email, $setting ) {
