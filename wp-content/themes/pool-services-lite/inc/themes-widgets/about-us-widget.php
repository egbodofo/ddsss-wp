...
class Pool_Services_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Pool_Services_Lite_About_Widget',
			__('VW About us', 'pool-services-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'pool-services-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','pool-services-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','pool-services-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','pool-services-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','pool-services-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','pool-services-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','pool-services-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function pool_services_lite_about_custom_load_widget() {
	register_widget( 'Pool_Services_Lite_About_Widget' );
}
add_action( 'widgets_init', 'pool_services_lite_about_custom_load_widget' );