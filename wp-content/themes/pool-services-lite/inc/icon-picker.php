...
class Pool_Services_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'pool-services-lite' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $pool_services_lite_font_awesome_icon_array = pool_services_lite_font_awesome_icon_array();
                    foreach ($pool_services_lite_font_awesome_icon_array as $pool_services_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $pool_services_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($pool_services_lite_font_awesome_icon).'"></i>
                            <span class="pool-services-lite-social-class">'.esc_attr($pool_services_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function pool_services_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'pool-services-lite-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'pool_services_lite_customizer_script' );

if(!function_exists('pool_services_lite_font_awesome_icon_array')){
    function pool_services_lite_font_awesome_icon_array(){
