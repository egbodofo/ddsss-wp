...
$demo_logo_light = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/lava_logo_light.png' );
$demo_r_logo_light = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/lava_logo_light@2x.png' );
$demo_small_logo = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/lava_small_logo.png' );
$demo_r_small_logo = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/lava_small_logo@2x.png' );
$demo_favicon = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/favicon.png' );
$demo_image = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/demo_image.jpg' );
$demo_page_header_image = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/demo_page_header.jpg' );
$demo_logo = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/demo-2/wp-content/uploads/sites/2/2018/01/lava_logo.png' );
...
$lava_fonts = array(
	array(
		'family' => 'Hind',
		'source' => 'Google',
		'variants' => '300,regular,italic,600,700,700italic',
	),
	array(
		'family' => 'Lobster Two',
		'source' => 'Google',
...
$homepage_data = lava_file_get_contents( LAVA_THEME_DIR .'/includes/prebuilt/layouts/homepage-2.json' );
$homapage_data_r = str_replace( 'image":1000,', 'image":'. $demo_image .',', $homepage_data );
$homepage_data = json_decode( $homapage_data_r, true );

$demo_page_home = Lava_Demo_Generator::add_page(array(
	'title' => 'Homepage',
	'template' => 'page-builder.php',
	'post_meta' => array(
		'_lava_page_header' => 'hide',
...
$contact_form_content = lava_file_get_contents( LAVA_THEME_DEMO_DIR .'/2/contents/contact_form.txt' );
...
$elements_data = lava_file_get_contents( LAVA_THEME_DEMO_DIR .'/2/contents/elements.json' );
...
$room_excerpt = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.';
...
Lava_Demo_Generator::add_widget_to_sidebar(
	...
	array(
		'title' => 'Get In Touch',
		'text' => '<div class="textwidget"><p class="address"><i class="material-icons">call</i>+855 123 456 78</p><p class="address"><i class="material-icons">email</i>info@lavahotel.com</p><p class="address"><i class="material-icons">location_on</i>2 W. Studebaker St. Miami Beach, FL 33139</p></div>',
	)
);
