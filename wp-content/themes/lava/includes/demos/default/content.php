...
$demo_logo_light = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/lava_logo_light.png' );
$demo_r_logo_light = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/lava_logo_light@2x.png' );
$demo_small_logo = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/lava_small_logo.png' );
$demo_r_small_logo = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/lava_small_logo@2x.png' );
$demo_favicon = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/favicon.png' );
$demo_image = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/demo_image.jpg' );
$demo_page_header_image = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/demo_page_header.jpg' );
$demo_logo = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/lava_logo.png' );

// get image srcs
$demo_logo_src = wp_get_attachment_image_src( $demo_logo, 'full' );
$demo_logo_light_src = wp_get_attachment_image_src( $demo_logo_light, 'full' );
$demo_r_logo_light_src = wp_get_attachment_image_src( $demo_r_logo_light, 'full' );
...
$demo_page_header_image_src = wp_get_attachment_image_src( $demo_page_header_image, 'full' );


// set demo options

Lava_Demo_Generator::update_theme_options(array(
	'logo' => $demo_logo_light_src[0],
	'logo_retina' => $demo_r_logo_light_src[0],
	'small_logo' => $demo_small_logo_src[0],
	'small_logo_retina' => $demo_r_small_logo_src[0],
	'logo_width' => 102,
	'logo_height' => 68,
	'page_header_image' => $demo_page_header_image_src[0]
));
...
$icon_service_1 = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/icon_service_1.png' );
$icon_service_2 = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/icon_service_2.png' );
$icon_service_3 = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/icon_service_3.png' );
$icon_360 = Lava_Demo_Generator::add_media_image( 'http://lava.themespirit.com/wp-content/uploads/2017/05/icon_360.png' );
...
$demo_page_home = Lava_Demo_Generator::add_page(array(
	...
	'template' => 'page-builder.php',
	'post_meta' => array(
		'_lava_page_header' => 'slider',
		'_lava_page_slider_shortcode' => '[masterslider alias="lava-home"]',
		'_lava_page_container' => 'no_container',
...
$contact_form_content = lava_file_get_contents( LAVA_THEME_DEMO_DIR .'/default/contents/contact_form.txt' );
...
$contact_us_data = lava_file_get_contents( LAVA_THEME_DIR .'/includes/prebuilt/layouts/contact-1.json' );
$contact_us_data = json_decode( $contact_us_data, true );
$contact_us_data['widgets'][3]['text'] = '<p style="text-align:center;margin-bottom:40px">Your email address will not be published. Required fields are marked <span style="color: #ff0000;">*</span></p><p>[contact-form-7 id="'. $contact_form_id .'" title="Lava contact form"]</p>';
...
$elements_data = lava_file_get_contents( LAVA_THEME_DEMO_DIR .'/default/contents/elements.json' );
...
update_option( 'tp_hotel_booking_custom_process', false );
...
Lava_Demo_Generator::add_widget_to_sidebar(
	...
	array(
		'title' => '',
		'text' => '<div class="center-align"><img width="102" height="68" src="'. $demo_logo_src[0] .'" alt="Lava Logo"></div>',
	)
);
...
Lava_Demo_Generator::add_widget_to_sidebar(
	...
	array(
		'title' => '',
		'text' => '<div class="textwidget"><p class="address"><i class="material-icons">near_me</i>205 West 21th Street, MIAMI FL</p><p class="address"><i class="material-icons">call</i>+855 123 456 78</p><p class="address"><i class="material-icons">email</i>info@lavahotel.com</p></div>',
	)
);
