...
if ( ! class_exists( 'Envato_Market_Github' ) ) :
	...
	class Envato_Market_Github {
		...
		public function plugins_api( $api, $action, $args ) {
			if ( isset( $args->slug ) && 'lava' === $args->slug ) {
		...
		public function notice() {
			...
			if ( 'deactivated' === $state ) {
				...
				$message = sprintf(
					esc_html__( '%sActivate the Envato Market plugin%s to get updates for your ThemeForest and CodeCanyon items.', 'lava' ),
				...
				$message = sprintf(
					esc_html__( '%sInstall the Envato Market plugin%s to get updates for your ThemeForest and CodeCanyon items.', 'lava' ),
