...
<a href="#" data-id="<?php echo esc_attr( $hb_room->ID ) ?>" data-name="<?php echo esc_attr( $hb_room->name ) ?>" class="btn-primary hb_primary" id="hb_room_load_booking_form"><?php esc_html_e( 'Book Now', 'lava' ); ?></a>